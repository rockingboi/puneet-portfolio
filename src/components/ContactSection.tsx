...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'puneet89upadhyay@gmail.com',
    href: 'mailto:puneet89upadhyay@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 93686 28114',
    href: 'https://wa.me/919368628114',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/puneet-sharma17',
    href: 'https://www.linkedin.com/in/puneet-sharma17/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@rockingboi',
    href: 'https://github.com/rockingboi',
  },
];
  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.15} y={20}>
        ...
        >
          Open to AI/ML roles · Mathura, India
        </p>
      </FadeIn>
